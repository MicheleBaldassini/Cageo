"""Define color conversions and palettes used by custom SHAP plots."""

import numpy as np
from matplotlib.colors import LinearSegmentedColormap
from colorconv import lab2rgb, lch2lab


def lch2rgb(x):
    """Convert an LCH color value to RGB."""
...
for pos, l, c, h in zip(
    np.linspace(0, 1, nsteps), l_vals, c_vals, h_vals
):  # noqa: E741
    lch = [l, c, h]
    rgb = lch2rgb(lch)
