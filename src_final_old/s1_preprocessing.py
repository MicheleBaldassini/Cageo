...
def split_datasets():
    ...
    for condition, dataset_path in dataset_paths.items():
        ...
        for dataset_name, target_df in target_datasets.items():
            ...
            print_slope_sample_breakdown(target_df, slope_groups, "Total")
            print_slope_sample_breakdown(train_df, slope_groups.iloc[train_idx], "Train")
            print_slope_sample_breakdown(test_df, slope_groups.iloc[test_idx], "Test")
